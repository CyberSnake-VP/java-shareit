...
public class BookingController {
    ...
    public ResponseEntity<Object> getBookings(@RequestHeader(USER_ID_HEADER) @Positive long userId,
        ...
        return bookingClient.getBookings(userId, BookingState.valueOf(stateParam.toUpperCase()), from, size);
    }
    ...
    public ResponseEntity<Object> getBookingsByState(@RequestParam(name = "state", defaultValue = "all")
        ...
        log.info("Проверяем stateParam={}", stateParam);
        BookingState.valueOf(stateParam.toUpperCase());
        return bookingClient.getBookingsByState(BookingState.valueOf(stateParam), from, size, userId);
    }
