...
public class ItemRequestController {
    ...
    public ItemRequestExitNoItemListDto create(@RequestHeader("X-Sharer-User-Id") @Positive Long userId,
    ...
    public List<ItemRequestExitDto> getByRequestorId(@RequestHeader("X-Sharer-User-Id") @Positive Long requestorId) {
